...
std::unique_ptr<shapes_traditional::Shape> SolidShapeFactory::create_circle(
    const double radius) const
{
    return std::make_unique<abstract_factory_pattern_common::SolidCircle>(radius);
}

std::unique_ptr<shapes_traditional::Shape> SolidShapeFactory::create_rectangle(
    const double width,
...
std::unique_ptr<shapes_traditional::Shape> SolidShapeFactory::create_triangle(
    const double base,
    const double height) const
{
