...
namespace memento_pattern_modern::vector_history {
...
struct CanvasSnapshot {
    ...
    std::optional<std::string> selected_shape;

    [[nodiscard]] std::size_t shape_count() const;
};

using CanvasHistory = std::vector<CanvasSnapshot>;
...
public:
    ...
    [[nodiscard]] CanvasSnapshot snapshot() const;
